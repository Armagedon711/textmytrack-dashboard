...
export default function PlayerModal({
  ...
  // Removed: Auto-minimize useEffect that was interfering with maximization.
  ...
  useEffect(() => {
    ...
    const initPlayer = () => {
      ...
      playerRef.current = new window.YT.Player(PLAYER_ID, {
        ...
        playerVars: {
          autoplay: 1,
          // CRITICAL FIX: Removed mute: 1 to stop hardcoding muted start.
          playsinline: 1,
          rel: 0,
          modestbranding: 1,
          controls: 1, 
  ...
  return (
    <>
      {/* Video Container (Fixed) - Positioning reverted for stacked layout.
        Video should be centered relative to the main modal container.
      */}
      <div 
        ...
        style={!isMinimized ? {
          ...
          top: '50%',
          left: '50%',
          // Transform offset updated for single column stacked layout (to sit above the controls)
      ...
      >
        ...
        >
          ...
          {/* Maximized Player Controls and Info (REVERTED TO STACKED LAYOUT) */}
          {!isMinimized && (
            <div className="flex flex-col h-full relative"> 
              ...
              {/* Controls and Info (Maximized, STACKED) */}
          ...
          {isMinimized && request && (
            <div className="flex items-center p-3 w-full">
              ...
              {/* Minimized Controls (Skip, Play/Pause, Maximize, Close) */}
